...
-- ----------------------------
INSERT INTO guestbook (userId, comment) VALUES 
  (6, 'Oh my God! This is the best website on the Internet!'),
  (4, 'Wow! I really like your customer service. Thanks'),
  (2, 'Hey! Where can I ask a simple question?'),
  (3, 'Extra comment'),
  (2, 'Provides great advice...Through case studies and user friendly diagrams and statistics you\'re able to understand the best approach...The ideas in this site and its analytical approach have inspired me, and I would recommend the site to anyone involved in fund-raising, sponsorship or funding applications.');
